...
**![Final 1](figures/Final_1.png)** <br><br>

**![Final 2](figures/Final_2.png)** <br><br>
...
The **[full notebook](Notebooks/Forecasting_for_a_Retail_Store.ipynb)** shows the experimentation, but the conclusion is clear: **SARIMAX** was the only model capable of accurately capturing all the complex drivers of retail sales.
